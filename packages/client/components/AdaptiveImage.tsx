...
export default forwardRef((props:AdaptiveImageProps, ref) => <AdaptiveImage {...props}  imageRef={ref as React.MutableRefObject<HTMLImageElement>}>{props.children}</AdaptiveImage>);